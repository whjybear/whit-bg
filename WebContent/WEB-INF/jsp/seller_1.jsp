...
<script type="text/javascript" src="<%=basePath%>js/service/sellerService.js"></script>
<script type="text/javascript" src="<%=basePath%>js/controller/baseController.js"></script>
<script type="text/javascript" src="<%=basePath%>js/controller/sellerController.js"></script>
			...
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					...
					<div class="modal-footer">
						...
						<button class="btn btn-danger" data-dismiss="modal"
							aria-hidden="true" ng-click="updateStatus(entity.sellerId,'3')">关闭商家</button>
